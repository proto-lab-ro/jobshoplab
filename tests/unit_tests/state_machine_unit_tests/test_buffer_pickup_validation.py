...
class TestGetJobPositionInPostbuffer:
    ...
    def test_job_found_at_index_0(self, create_buffer_state):
        ...
        buffer = create_buffer_state(
            "postbuffer-1", BufferStateState.NOT_EMPTY, ("job-1", "job-2", "job-3")
        )
...
class TestIsCorrectPositionForBufferType:
    ...
    @pytest.mark.parametrize(
        "buffer_type,job_position,buffer_length,expected",
        [
    ...
    def test_position_validation_for_buffer_types(
        self, buffer_type, job_position, buffer_length, expected
    ):
...
class TestIsJobReadyForPickupFromPostbuffer:
    ...
    @pytest.mark.skip(
        reason="Need proper InstanceConfig fixture - will implement in integration tests"
    )
    ...
    def test_job_not_ready_fifo_second_position(
        self, minimal_instance_dict, default_init_state_result
    ):
...
class TestBufferPickupIntegration:
    ...
    def test_fifo_buffer_pickup_validation(self, fifo_buffer_config, create_buffer_state):
        ...
        buffer_state = create_buffer_state(
            "fifo-postbuffer", BufferStateState.NOT_EMPTY, ("job-1", "job-2", "job-3")
        )
    ...
    def test_lifo_buffer_pickup_validation(self, lifo_buffer_config, create_buffer_state):
        ...
        buffer_state = create_buffer_state(
            "lifo-postbuffer", BufferStateState.NOT_EMPTY, ("job-1", "job-2", "job-3")
        )
    ...
    def test_flex_buffer_pickup_validation(self, flex_buffer_config, create_buffer_state):
        ...
        buffer_state = create_buffer_state(
            "flex-postbuffer", BufferStateState.NOT_EMPTY, ("job-1", "job-2", "job-3")
        )
